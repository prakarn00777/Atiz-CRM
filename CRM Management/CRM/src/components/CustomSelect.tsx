    ...
    return (
        <div className={`relative ${className || ""}`} ref={containerRef}>
            ...
            <button
                ...
                className={`input-field flex items-center justify-between group cursor-pointer active:scale-[0.99] transition-all duration-200 ${icon ? "pl-9" : className?.includes("pl-") ? "" : "pl-3"} ${className?.includes("h-") ? "" : "py-2"} ${className || ""}`}
            >
                {icon && (
